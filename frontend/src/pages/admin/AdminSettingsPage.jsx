...
import { User, Camera, Save, Shield, Server } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-evora-text-secondary">Manage your admin profile and platform preferences.</p>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-evora-text-muted mt-0.5">Your administrative role</p>
            </div>
      ...
      <div className="rounded-2xl border border-evora-border bg-evora-surface-secondary p-6 shadow-soft">
        <h2 className="font-display text-lg font-semibold text-evora-text-primary mb-4">
          <span className="flex items-center gap-2">
            <Server className="h-5 w-5 text-evora-primary" />
            Platform
          </span>
        </h2>
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl bg-evora-surface-muted p-4">
            <p className="text-xs font-medium text-evora-text-muted uppercase tracking-wider">Platform</p>
            <p className="mt-1 text-sm font-semibold text-evora-text-primary">EVORA</p>
          </div>
          <div className="rounded-xl bg-evora-surface-muted p-4">
            <p className="text-xs font-medium text-evora-text-muted uppercase tracking-wider">Version</p>
            <p className="mt-1 text-sm font-semibold text-evora-text-primary">1.0.0</p>
          </div>
          <div className="rounded-xl bg-evora-surface-muted p-4">
            <p className="text-xs font-medium text-evora-text-muted uppercase tracking-wider">Environment</p>
            <p className="mt-1 text-sm font-semibold text-evora-text-primary">
